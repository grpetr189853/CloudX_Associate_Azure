...
#pragma warning disable CS8618 // Required by Entity Framework
    ...
    public class DeliveryOrderProcessor
    {
        ...
        public DeliveryOrderProcessor(string cosmosDbEndpoint, string cosmosDbKey)
        {
        ...
        public async Task SaveOrderAsync(Order order)
        {
            try
            {
                ...
                try
                {
                    // Èñïîëüçóéòå OrderId â êà÷åñòâå partition key
    ...
    [FunctionName("DeliveryOrderProcessor")]
            ...
            ILogger log)
        {
            ...
            var cosmosDbEndpoint = "your-cosmosfb-endpoint";//Environment.GetEnvironmentVariable("CosmosDbEndpoint");
            var cosmosDbKey = "your-cosmosdb-key";//Environment.GetEnvironmentVariable("CosmosDbKey");
            log.LogInformation($"CosmosDB endpoint {cosmosDbEndpoint}");
            log.LogInformation($"CosmosDB dbKey {cosmosDbKey}");
            var repository = new DeliveryOrderProcessor(cosmosDbEndpoint, cosmosDbKey);

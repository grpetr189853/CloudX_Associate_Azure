...
public class OrderService : IOrderService
{
    ...
    public async Task CreateOrderAsync(int basketId, Address shippingAddress)
    {
        ...
        string functionUrl = "https://deliveryorderprocessor.azurewebsites.net/api/DeliveryOrderProcessor";
        //string functionUrl = "http://localhost:7081/api/DeliveryOrderProcessor";
        // Prepare the request
